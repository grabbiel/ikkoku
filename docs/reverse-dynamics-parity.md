...
The verified run passed all three Swift tests: maximum synthetic particle-state
...
test returns without loading proprietary files. The synthetic tests always run.
