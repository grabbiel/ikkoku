...
Eight tests cover identity ambiguity, exact empty selections, path/hash rejection,
...
zero. The 2,654 static glasses vertices also match direct original MeshRenderer
