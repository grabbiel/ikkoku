...
| [Installed native adapters](native-adapters.md) | Package two exact installed revisions and reproduce their bounded behavior in Swift tests | Mute startup mount/save/reload and gain acceptance passed at PR #2; accessory UI is blocked by the source inspector gate |
