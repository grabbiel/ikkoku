...
Reviewed 2026-09-25. This reference records the head-00 scalar/FBS contract and
its numerical fixtures. The same evaluator accepts the separate contracts
generated for normal heads 200/201; counts and hashes below remain head-00
evidence. Blink/transition clocks are implemented separately in
[temporal playback](../animation/expression-playback.md). Source gaze,
voice-driven mouth rates, mouth-width writes and tears still need integration;
see the [component audit](../../component-audit/character-and-mods.md)
(CM-33–35, CMT-06). Commands run from the repository root.
