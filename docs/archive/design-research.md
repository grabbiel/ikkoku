...
Archived research for the initial generated-content Maker/Studio prototype.
The original note described a tooling-only project built from public guides and
independent assets. That scope was superseded by the local original-data, gameplay
and voice work. It is not a clean-room claim about the current repository.

The feature lists and links below are preserved design inputs, not verified source
contracts or a current support matrix. External links were not revalidated in the
2026-09-25 documentation pass. Use the [current architecture](../architecture.md),
[component audit](../component-audit/README.md) and [archive index](README.md).
...
## 4. Original prototype scope (superseded)
